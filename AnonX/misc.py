...
def sudo():
    ...
    if sudoers:
        for x in sudoers:
            SUDOERS.add(x)
    LOGGER(__name__).info(f" 𓂃⃪ํֶ𝙎𝙈𝘼𝙍𝙏𝙔 𝙑𝙁™ ̶꯭❍͢͠ᴘ𓂃[🇮🇳] Sudo Users Loaded Successfully.")
    ...
    if is_heroku:
        if config.HEROKU_API_KEY and config.HEROKU_APP_NAME:
            try:
                ...
                LOGGER(__name__).info(f"𝐇𝐄𝐑𝐎𝐊𝐔 𝐀𝐏𝐏 𝐂𝐎𝐍𝐅𝐈𝐆𝐔𝐑𝐄𝐃 𝐒𝐔𝐒𝐒𝐂𝐄𝐅𝐔𝐋𝐋𝐘 𝐍𝐎𝐖 𝐃𝐑𝐎𝐏 𝐘𝐎𝐔𝐑 𝐆𝐅 𝐍𝐔𝐃𝐄𝐒 𝐓𝐎 𓂃⃪ํֶ𝙎𝙈𝘼𝙍𝙏𝙔 𝙑𝙁™ ̶꯭❍͢͠ᴘ𓂃[🇮🇳]•─⃛͢.")
